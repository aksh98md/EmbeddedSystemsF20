#!/usr/bin/python3
# Forked from https://github.com/quangthanh010290/BL_keyboard_RPI
...
class Keyboard():
    ...
    def addToEventsAndSave(self, event):
        self.events.append(event)

        
        pickle.dump( self.events, open( sys.argv[1], "wb" ) )
        print(sys.argv[1])
